...
files = dir("/sc/arion/projects/roussp01a/gabriel/ref_panels/1kg/", pattern="*.map", full.names=TRUE)
...
gds = GenomicDataStream(file, field="GT", init=TRUE, samples=sampleIDs, MAF=0.05)

df_chrom = df[df$CHROM == 22,]
