...
res = impute_region(df_chrom[-idx,], gds, region, flank)
...
window = 1000000
v = c(10000, 50000, 100000, 500000, 1000000, 2000000, 3000000)
res = mclapply(v, function(flankWidth){
  gds = GenomicDataStream(file, field="GT", init=TRUE, samples=sampleIDs, MAF=0.01)

  s = seq(1, 100000)
  res = run_imputez(df_chrom[-idx,][s,], gds, window, flankWidth)
  res$flankWidth = flankWidth
  res
  }, mc.cores=12)
names(res) = v
